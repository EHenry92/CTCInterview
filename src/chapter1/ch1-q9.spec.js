...
for (let key in funcs) {
  ...
  describe('ch1-q9: ' + key, function() {
    ...
    xit('throws an error when either string is null/undefined/empty', function() {
    ...
    xit('returns false when strings are different lengths', function() {
    ...
    describe('rotations of a long string', function() {
      ...
      for (let i = 1; i < str.length; i += 12) {
        ...
        xit(`returns true for rotated string ${rStr}`, function() {
      ...
      for (let i = 1; i < str.length; i += 12) {
        ...
        xit(`returns false for non-rotated string ${rStr}`, function() {
